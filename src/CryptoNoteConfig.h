...
const uint32_t UPGRADE_HEIGHT_V2 = 91000; // Block v2, pre-LWMA
const uint32_t UPGRADE_HEIGHT_V3 = 91100; // Block v3, LWMA1
const uint32_t UPGRADE_HEIGHT_V3_1 = 91150; // Min fee v2, cap max mixin
const uint32_t UPGRADE_HEIGHT_V4 = 91300; // Block v4, LWMA2, adaptive min fee, min mixin, disable slave merge mining
const uint32_t UPGRADE_HEIGHT_V4_1 = 91320; // LWMA3
...
const uint32_t UPGRADE_HEIGHT_V7 = 113000; // Block v7
const uint32_t UPGRADE_HEIGHT_V8 = 4294967294; // Block v8
...
const char* const SEED_NODES[] = {
  ...
  "65.20.104.165:49200",
  "149.28.46.208:49200",
  "95.179.212.172:49200",
  "139.180.187.204:49200",
};
