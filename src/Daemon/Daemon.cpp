...
namespace
{
  ...
  bool command_line_preprocessor(const boost::program_options::variables_map &vm, LoggerRef &logger) {
    ...
    if (command_line::get_arg(vm, command_line::arg_version)) {
      std::cout << CryptoNote::CRYPTONOTE_NAME << " v" << "1.0.2" << ENDL;
      exit = true;
    }
...
int main(int argc, char* argv[])
{
  ...
  try {
    ...
    bool r = command_line::handle_error_helper(desc_options, [&]()
    {
      ...
      {
        std::cout << CryptoNote::CRYPTONOTE_NAME << " v" << "1.0.2" << ENDL << ENDL;
    ...
    logger(INFO) << CryptoNote::CRYPTONOTE_NAME << " v. " << "1.0.2";
    ...
    ": _______   ______     _______  _______ .___  ___.   ______   .__   __.  _______ #:\n"
    ...
    ":|  |  |  |  |  |  | |  | |_ | |   __|  |  |\/|  | |  |  |  | |  . `  | |   __|  #:\n"
    ":|  '--'  |  `--'  | |  |__| | |  |____ |  |  |  | |  `--'  | |  |\   | |  |____ #:\n"
    ":|_______/ \______/   \______| |_______||__|  |__|  \______/  |__| \__| |_______|#:\n",
